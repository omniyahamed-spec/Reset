...
const ONBOARDING_SLIDES = [
  {
    tag: "The gap",
    accent: "#E05D2A",
    title: "You already know.\nYou still are not moving.",
    body: "Therapy explores how you feel. Productivity apps organize known tasks. Reset works in the gap between knowing and doing.",
  },
  {
    tag: "Action intelligence",
    accent: "#0D9488",
    title: "See it.\nDecide it. Do it.",
    body: "Reset identifies the mechanism behind hesitation, turns it into one executable decision, and gives you a behavioural principle to reuse.",
  },
  {
    tag: "Three steps",
    accent: "#7C3AED",
    title: "Coach. Chief. Train.",
    body: "Coach exposes what is stopping you. Chief makes the next decision. Train builds the mentality that makes action easier next time.",
  },
];
      ...
      <div style={S.wrap}>
        ...
        {false && screen === "start" && journey && (
          <>
              ...
              <div style={S.heroOverlay}>
                ...
                <div style={S.heroBottom}>
                  ...
                  <div style={S.heroFoot}>
                    Action intelligence, built from your own behaviour.
                  </div>
                </div>
              </div>
            </div>

            {/* Daily lenses removed from the core product. Reset now owns one proprietary loop: Coach → Chief → Train. */}
            ...
            {/* Training is now Step 3 of every Reset, not a separate content area. */}
          ...
          renderStepCard(
            ...
            <>
              ...
              <input
                ...
                onChange={(e) => setAvoiding(e.target.value)}
                onKeyDown={(e) =>
                  e.key === "Enter" && avoiding.trim() && setScreen("chief")
                }
              />
              <div style={S.helperRow}>
        ...
        {screen === "result" && latestEntry && (
          <div style={S.card}>
            ...
            {aiFeedbackLoading ? (
              ...
              <>
                <div style={S.aiFeedbackBox}>
                  <div style={S.aiBadge}>Coach · See the mechanism</div>
                  <div style={S.feedbackText}>{aiFeedback.coachInsight}</div>
                </div>
                <div style={{ ...S.aiFeedbackBox, background: "#161413", borderColor: "#2A2520" }}>
                  <div style={{ ...S.aiBadge, color: "rgba(214,174,104,0.9)" }}>Chief · Execute the decision</div>
