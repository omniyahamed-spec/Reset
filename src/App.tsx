      ...
      <div style={S.wrap}>
          ...
          <div style={S.modalBackdrop}>
            <div
              style={{
                ...
                maxWidth: 420,
                background:
                  followUpAnswer === "confirmed" ? "#0D1A0D" : "#1A0D0D",
                borderRadius: 28,
                border: `1px solid ${
            ...
            >
              ...
              <div
                style={{
                  ...
                  color:
                    followUpAnswer === "confirmed"
                      ? "rgba(200,240,200,0.55)"
                      : "rgba(245,200,200,0.45)",
                }}
              >
                {followUpAnswer === "confirmed"
            ...
            >
              <div
                style={{
                  ...
                  borderRadius: "50%",
                  background:
                    "radial-gradient(circle, rgba(180,140,90,0.08) 0%, transparent 70%)",
                  pointerEvents: "none",
                }}
              />
              <div
        ...
        {screen === "insights" && (
          <div style={S.card}>
            ...
            <div style={S.sub}>
              Based on your last {Math.min(entries.length, 50)} resets.
            </div>
            <div style={S.summaryGrid}>
              {[
                ...
                {
                  num:
                    patterns.avgPresence > 0
                      ? `${patterns.avgPresence}/5`
                      : "—",
                  label: "Avg presence",
                },
              ].map(({ num, label }) => (
              ...
              <div style={S.insightRow}>
                ...
                <div>
                  ...
                  <div style={S.insightBody}>
                    "{patterns.topAvoiding}" shows up more than anything else.
                    It's not a task problem — it's a resistance pattern.
                  </div>
                </div>
              </div>
            )}
            {patterns.avgPresence > 0 && patterns.avgPresence < 3 && (
              <div style={S.insightRow}>
                ...
                <div>
                  ...
                  <div style={S.insightBody}>
                    Your average presence is {patterns.avgPresence}/5. The
                    arrival practice matters most for you — don't skip it.
                  </div>
                </div>
              </div>
            )}
            {patterns.avgPresence >= 4 && (
              <div style={S.insightRow}>
                ...
                <div>
                  ...
                  <div style={S.insightBody}>
                    Average presence {patterns.avgPresence}/5. You're doing the
                    inner work. That's rare.
                  </div>
                </div>
              </div>
            )}
            {patterns.mostProductiveDays.length > 0 && (
              <div style={S.insightRow}>
                ...
                <div>
                  ...
                  <div style={S.insightBody}>
                    You complete moves most on{" "}
                    {patterns.mostProductiveDays.join(" and ")}. Schedule your
                    hardest tasks then.
                  </div>
                </div>
              </div>
            ...
            {patterns.completionRate < 50 && entries.length >= 5 && (
              <div style={S.insightRow}>
                ...
                <div>
                  ...
                  <div style={S.insightBody}>
                    {100 - patterns.completionRate}% of the time you don't
                    follow through. Make the move smaller.
                  </div>
                </div>
              </div>
            )}
            ...
            <div style={S.historyList}>
              {entries.length === 0 ? (
                <div style={S.emptyState}>
                  No resets yet. Do your first one.
                </div>
              ) : (
                entries.map((entry) => (
                  <div key={entry.id} style={S.historyCard}>
                    <div style={S.historyTop}>
                      ...
                      >
                        {entry.presenceScore && (
                          <span
                            style={{
                              fontSize: 11,
                              color:
                                PRESENCE_LABELS[entry.presenceScore]?.color,
                              fontWeight: 700,
                            }}
                          >
                        ...
                        <span style={S.statusBadge(entry.status)}>
                    ...
                    <div
                      style={{ ...S.historyLine, marginBottom: 0 }}
                    >
                      <span style={S.historyLineLabel}>Feedback </span>
                      {entry.feedback}
                    </div>
                  </div>
                ))
            ...
            <div style={S.modalCard}>
              ...
              <div style={S.modalBody}>
                ...
                <div style={S.modalText}>
                  {latestEntry.status === "done"
                    ? "The move is made. That's all it takes."
                    : "Sit with it. Then make the move smaller."}
                </div>
                <div style={S.summaryGrid}>
                  {[
                    { num: totalResets, label: "Total resets" },
              ...
              <div style={S.modalBody}>
                ...
                <div style={S.summaryGrid}>
                  {[
                    ...
                    <div key={label} style={S.summaryBoxGold}>
                      <div style={S.summaryNumGold}>{num}</div>
                      <div style={S.summaryLabelGold}>{label}</div>
                    </div>
                  ))}
                </div>
                <div
