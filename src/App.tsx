    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          background: "radial-gradient(circle, rgba(180,140,90,1) 0%, transparent 70%)",
      ...
      {slide > 0 && (
        <button
          ...
          style={{
            ...
            fontSize: 12, color: "rgba(245,241,234,0.3)",
      ...
      <div key={slide} style={{
        ...
        <div style={{
          ...
          <span style={{ fontSize: 11, fontWeight: 700, letterSpacing: "0.18em", textTransform: "uppercase", color: "rgba(180,140,90,0.7)" }}>
            {current.tag}
          </span>
          <div style={{ width: 20, height: 1, background: "rgba(180,140,90,0.5)" }} />
        </div>
        ...
        <button
          ...
          style={{
            ...
            background: isLast ? "rgba(245,241,234,0.92)" : "rgba(245,241,234,0.08)",
            color: isLast ? "#161413" : "rgba(245,241,234,0.75)",
            fontSize: 14, fontWeight: isLast ? 800 : 400,
      ...
      <div style={{
        ...
        {ONBOARDING_SLIDES.map((_, i) => (
          <div key={i} style={{
            ...
            background: i === slide ? "rgba(180,140,90,0.7)" : "rgba(245,241,234,0.15)",
...
export default function App() {
  ...
  useEffect(() => {
    ...
    const timer = window.setTimeout(() => setFollowUpSeconds(s => (s ?? 1) - 1), 1000);
    return () => window.clearTimeout(timer);
  }, [followUpSeconds]);
      ...
      <div style={S.wrap}>
          ...
          <div style={S.card}>
            ...
            {latestEntry.status === "done" && followUpSeconds !== null && !showFollowUp && !followUpAnswer && (
              <div style={{
                ...
                <div>
                  <div style={{ fontSize: 11, fontWeight: 700, letterSpacing: "0.12em", textTransform: "uppercase" as const, color: "rgba(245,241,234,0.3)", marginBottom: 4 }}>
                    Follow-up in
                  </div>
                  <div style={{ fontSize: 13, color: "rgba(245,241,234,0.6)" }}>
                    Did you actually do it?
                  </div>
                </div>
                <div style={{
                  fontSize: 22, fontWeight: 500, color: "rgba(245,241,234,0.85)",
                  fontFamily: 'Iowan Old Style,"Palatino Linotype","Book Antiqua",Georgia,serif',
                  letterSpacing: "-0.03em",
                  minWidth: 52, textAlign: "right" as const,
                }}>
                  {Math.floor(followUpSeconds / 60)}:{String(followUpSeconds % 60).padStart(2, "0")}
                </div>
              </div>
            )}
        ...
        {showFollowUp && !followUpAnswer && latestEntry && (
          <div style={S.modalBackdrop}>
            <div style={{
              ...
              background: "#161413", borderRadius: 28,
              border: "1px solid #2A2520",
              ...
              <div style={{ fontSize: 10, fontWeight: 800, letterSpacing: "0.18em", textTransform: "uppercase" as const, color: "rgba(245,241,234,0.3)", marginBottom: 12 }}>
                5-minute check
              </div>
              <div style={{
              ...
              <div style={{
                background: "rgba(245,241,234,0.04)", border: "1px solid rgba(245,241,234,0.08)",
                borderRadius: 12, padding: "10px 14px", marginBottom: 22,
              }}>
                <div style={{ fontSize: 11, color: "rgba(245,241,234,0.3)", marginBottom: 3, textTransform: "uppercase" as const, letterSpacing: "0.1em", fontWeight: 700 }}>Your move</div>
                <div style={{ fontSize: 14, color: "rgba(245,241,234,0.7)", lineHeight: 1.4 }}>{latestEntry.move}</div>
              </div>
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 }}>
                <button
                  onClick={() => setFollowUpAnswer("confirmed")}
                  style={{
                    padding: "14px 10px", borderRadius: 16, border: "none",
                    background: "rgba(245,241,234,0.9)", color: "#161413",
                    fontSize: 14, fontWeight: 800, cursor: "pointer", fontFamily: "inherit",
                  }}
                >Yes, done ✓</button>
                <button
                  onClick={() => setFollowUpAnswer("slipped")}
                  style={{
        ...
        {followUpAnswer && (
          <div style={S.modalBackdrop}>
            <div style={{
              width: "100%", maxWidth: 420,
              background: followUpAnswer === "confirmed" ? "#0D1A0D" : "#1A0D0D",
              borderRadius: 28,
              border: `1px solid ${followUpAnswer === "confirmed" ? "rgba(46,125,50,0.4)" : "rgba(139,30,30,0.4)"}`,
              boxShadow: "0 25px 80px rgba(0,0,0,0.5)",
              padding: 28,
            }}>
              <div style={{
                fontSize: 26, fontWeight: 500,
                color: followUpAnswer === "confirmed" ? "rgba(200,240,200,0.9)" : "rgba(245,200,200,0.9)",
                fontFamily: 'Iowan Old Style,"Palatino Linotype","Book Antiqua",Georgia,serif',
                letterSpacing: "-0.03em", lineHeight: 1.2, marginBottom: 12,
              }}>
                {followUpAnswer === "confirmed" ? "That's the whole point." : "Still carrying it."}
              </div>
              <div style={{
                fontSize: 14, lineHeight: 1.65, marginBottom: 24,
                color: followUpAnswer === "confirmed" ? "rgba(200,240,200,0.55)" : "rgba(245,200,200,0.45)",
              }}>
                {followUpAnswer === "confirmed"
                  ? "You said you'd do it. You did it. That's not small — that's the whole practice."
                  : "That's honest. The move was probably still too big. Tomorrow, make it half the size."}
              </div>
              <button
                onClick={resetFlow}
                style={{
                  width: "100%", padding: "14px 18px", borderRadius: 16,
                  border: `1px solid ${followUpAnswer === "confirmed" ? "rgba(46,125,50,0.3)" : "rgba(139,30,30,0.3)"}`,
                  background: "transparent",
                  color: followUpAnswer === "confirmed" ? "rgba(200,240,200,0.7)" : "rgba(245,200,200,0.6)",
                  fontSize: 14, cursor: "pointer", fontFamily: "inherit",
                }}
